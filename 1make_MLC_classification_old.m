...
name=strxcat(Rsize,'_msub',minsub');                    %Used as Std
...
%single day and run 1make_MLC_classification without the loop (if you e.g. want to plot pie plots). If you use/do not use the 
