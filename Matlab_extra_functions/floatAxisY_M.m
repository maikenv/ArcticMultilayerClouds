...
hl1 = plot(x,y,'LineWidth',lsize,'Color',lcolor,'LineStyle',lstyle);            %Maiken new;
...
if (nargin < 5)
   ...
   ylimit = get(ax2,'YLim');
elseif (isnan(limits))                                                    %Maiken new;
   ylimit = get(ax2,'XLim');
else
...
set(ax3,'YMinorTick','off','color','none','ycolor','k')                             %Maiken new
...
if (nargin > 3)
   %xlabel(xlbl,'FontSize',lsize,'Color',lcolor,'FontSize',textsize);                %Maiken new
   ylabel(ylbl,'FontSize',lsize,'Color','k','FontSize',textsize);                    %Maiken new
end 
