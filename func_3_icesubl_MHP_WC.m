...
%Westbrook:
A=0.05;                                         %Aspect ratio: Plate: A>1, column: A<1                              
C(1)=0.58*(1+0.95*A^(0.75))*r1(1);

%%
%Mitchell: hexagonal plates (P1a)
if dp(1)> 15e-6 && dp(1)<=100e-6
    alpha(1)=0.00739;
    beta(1)=2.45;
    gamma(1)=0.24;
    sigma(1)=1.85;
elseif dp(1)> 100e-6 && dp(1)<=3000e-6
    alpha(1)=0.00739;
    beta(1)=2.45;
    gamma(1)=0.65;
    sigma(1)=2.00;
...
for t=2:1:1000000000                %dt in 0.01 sek 
    ...
    C(t)=0.58*(1+0.95*A^(0.75))*r1(t);      %Westbrook

    if  dp(t)<=100e-6 %dp(t)> 15e-6 &&
        alpha(t)=0.00739;
        beta(t)=2.45;
        gamma(t)=0.24;
        sigma(t)=1.85;
    elseif dp(t)> 100e-6 && dp(t)<=3000e-6
        alpha(t)=0.00739;
        beta(t)=2.45;
        gamma(t)=0.65;
        sigma(t)=2.00;
