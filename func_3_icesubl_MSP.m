function [maxtime, Sublimation, esati, esatiM]=func_3_icesubl_MSP(RHi1,TK1,P1,z1,r1)
...
%Westbrook: star crystal
A=0.3;                                         %Aspect ratio: Plate: A>1, column: A<1                              
C(1)=0.596*(1-0.38*exp(-4.7*A))*r1(1);

%%
%Mitchell: Crystal with sector like branches (P1b)
if  dp(1)<=40e-6 %&& dp(1)> 10e-6 
    alpha(1)=0.00614;
    beta(1)=2.42;
    gamma(1)=0.24;
    sigma(1)=1.85;
elseif dp(1)> 40e-6 && dp(1)<=2000e-6
    alpha(1)=0.00142;
    beta(1)=2.02;
    gamma(1)=0.55;
    sigma(1)=1.97;
...
for t=2:1:1000000000                %dt in 0.01 sek 
    ...
    C(t)=0.596*(1-0.38*exp(-4.7*A))*r1(1);          %Westbrook
    
    %Mitchell: Crystal with sector like branches (P1b)
    if  dp(t)<=40e-6 %&& dp(1)> 10e-6 
        alpha(t)=0.00614;
        beta(t)=2.42;
        gamma(t)=0.24;
        sigma(t)=1.85;
    elseif dp(t)> 40e-6 && dp(t)<=2000e-6
        alpha(t)=0.00142;
        beta(t)=2.02;
        gamma(t)=0.55;
        sigma(t)=1.97;
