...
load(strxcat('MLC_classification_50_msub100.mat')) 
MLC_classification50=MLC_classification;
[XL50] = func_4_histogram(MLC_classification50, index);

load(strxcat('MLC_classification_150_msub100.mat')) 
MLC_classification150=MLC_classification;
[XL150] = func_4_histogram(MLC_classification150, index);

load(strxcat('MLC_classification_100_msub100.mat'))
...
saveas(gcf,strxcat('Plots/8_Raso/Histogram_Raso_radii',name,'.pdf'));
...
clear a_0cloud a_1cloud a_all a_both a_cloudcover a_Nan a_nonNan a_nonseed a_onlyseed Anz_DateNan ...
    ...
    MLC_classification50 MLC_classification150  NumGroupsPerAxis NumStackElements NumStacksPerGroup XL50 ...
    XL100 XL150 XLall
